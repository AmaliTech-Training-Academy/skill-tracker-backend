package com.amalitech.analytics.service.security.util;

import com.amalitech.analytics.service.model.enums.Role;
...
public class JwtUtil {
    ...
    /**
     * Extracts the userid (subject) from the given JWT token.
     *
     * @param token the JWT token
     * @return the email contained in the token
     */
