...
/**
 * Utility class for interacting with Redis using {@link StringRedisTemplate}.
 * Provides simple methods to set, get, delete, and check existence of keys in Redis.
 *
 * <p>All values are stored as strings. TTL (time-to-live) is specified in seconds where applicable.</p>
 */
@Component
